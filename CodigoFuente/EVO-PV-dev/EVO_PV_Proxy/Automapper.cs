    ...
    public class Automapper
    {
        ...
        public Automapper()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<PedidoConsultaResponse, BOPedidoConsultaResponse>();
                cfg.CreateMap<ArticuloConsultaResponse, BOArticuloConsultaResponse>();
                cfg.CreateMap<AccionCompraResponse, BOAccionCompraResponse>();
                cfg.CreateMap<ArticuloAccionCompraResponse, BOArticuloAccionCompraResponse>();
                cfg.CreateMap<MotivoResponse,MotivoRespuesta>();
                cfg.CreateMap<BOCancelarPedidoRequest,CancelarPedidoRequest>();
                cfg.CreateMap<BOEditarPedidoRequest, EditarPedidoRequest>();
                cfg.CreateMap<BOEditarPedidoRequestArticulos, EditarPedidoRequestArticulos>();
                cfg.CreateMap<SerieResponse, BOSerieResponse>();
