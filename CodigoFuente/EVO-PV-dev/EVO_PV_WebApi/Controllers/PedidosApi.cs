...
namespace EVO_PV_WebApi.Controllers
{
    ...
    public class PedidosApiController : BaseController
    {
        ...
        {
            logger.Info($"Entró al método CancelarPedido en EVO_PV_WebApi con los parametros body = {JsonConvert.SerializeObject(body)}");
        ...
        {
            logger.Info($"Entró al método EditarPedido en EVO_PV_WebApi con los parametros body = {JsonConvert.SerializeObject(body)}");
            ...
            try
            {
                ...
                bool respuesta = pedidoBL.EditarPedido(boPedido);
        ...
        public PedidoConsultaResponse ObtenerConsultaPedido(int pedidoId)
        {
            try
            {

                logger.Info($"Entró el método ObtenerConsultaPedido en EVO_PV_WebApi con el parametro pedidoId = {pedidoId}");

                PedidoBL pedidoBL = new PedidoBL();

                BOPedidoConsultaResponse boPedido = pedidoBL.ObtenerConsultaPedido(pedidoId);
        ...
        public bool ExisteSolicitudPlantasBorrador()
        {
            try
            {
                PedidoBL pedidoBL = new PedidoBL();
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(bool), description: "Operación realizada con éxito")]
        public bool HabilitarSolicitudPedido()
        {
            try
            {
                PedidoBL pedidoBL = new PedidoBL();
                ...
                string codigoCliente = appConfiguration.AppSettings["CODIGO_PUNTO_VENTA"].ToString();
        ...
        public async Task<string> ActualizarPedido([FromBody] PedidoRequest body)
        {
            BOPedidoRespuesta bOPedidoRespuesta = null;
            ...
            try
            {
                ...
                pedido.WhsCode = codigoPuntoVenta;

                string respuesta = await pedidoBL.ActualizarPedido(pedido);

                return respuesta;
            }
            catch (EVOException e)
            {
                bOPedidoRespuesta = new BOPedidoRespuesta() { Estado = false, Codigo = string.Empty, RespuestaSAP = e.Message };
                return JsonConvert.SerializeObject(bOPedidoRespuesta);
            }
            catch (Exception e)
            {
                bOPedidoRespuesta = new BOPedidoRespuesta() { Estado = false, Codigo = string.Empty, RespuestaSAP = e.Message };
        ...
        public async Task<string> CrearPedido([FromBody] PedidoRequest body)
        {
            BOPedidoRespuesta bOPedidoRespuesta = null;
            ...
            try
            {
                ...
                string respuesta =  await pedidoBL.CrearPedido(pedido);
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(ObtenerTodosPedidosResponse), description: "Operación realizada con éxito")]
        public async Task<ObtenerTodosPedidosResponse> ObtenerTodosPedidos(int desde, int hasta)
        {
            try
            {
                ...
                string whsCode = appConfiguration.AppSettings["CODIGO_PUNTO_VENTA"].ToString();
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(ObtenerTodosPedidosResponse), description: "Operación realizada con éxito")]
        public async Task<string> ObtenerTodosPedidosxFiltro([FromBody] FiltrarPedidoRequest body)
        {
            try
            {
                PedidoBL pedidoBL = new PedidoBL();
