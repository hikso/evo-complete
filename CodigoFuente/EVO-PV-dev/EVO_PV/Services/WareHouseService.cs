...
namespace EVO_PV.Services
{
    ...
    public class WareHouseService : Mapper
    {
        ...
        public async Task<List<BOWareHouse>> GetFactories()
        {
            ...
            try
            {
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    Uri url = new Uri(domain + "bodegas/planta");
        ...
        /// </summary>
        /// <returns>Lista de plantas de tipo WareHouse</returns>
        public async Task<List<BOWareHouse>> GetAllFactories()
        {
            ...
            try
            {
                ...
                {
                    CredentialCache cc = new CredentialCache();
                    Uri url = new Uri(ConfigurationManager.AppSettings["API_EVO"] + "bodegas/solicitud");
                    client.UseDefaultCredentials = true;
        ...
        /// <summary>
        /// Método que retorna los tipos de plantas o bodegas o puntos de venta
        /// </summary>
        /// <returns>Lista de tipos con sus respectuvas plantas, puntos de venta</returns>
        public async Task<List<BOWareHouseTypes>> GetFactorieTypes()
        {
            try
            {
                List<BOWareHouseTypes> factories = null;
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    Uri url = new Uri(domain + "bodegas/tipos");
                    client.UseDefaultCredentials = true;
                    
                    client.Encoding = Encoding.UTF8;
                    var HtmlResult = await client.DownloadStringTaskAsync(url.AbsoluteUri);
                    List<BOObtenerTipoBodegaAResponse> response = JsonConvert.DeserializeObject<List<BOObtenerTipoBodegaAResponse>>(HtmlResult);
                    factories = this.mapper.Map<List<BOObtenerTipoBodegaAResponse>, List<BOWareHouseTypes>>(response);
                }
        ...
        public BOWareHouse GetWareHouseByCode(string code)
        {
            ...
            try
            {
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    Uri url = new Uri(domain + $"bodegas/{code}");
        ...
        public async Task<List<BOWareHouse>> GetSalePoints()
        {
            ...
            try
            {
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    Uri url = new Uri(domain + "bodegas/puntoventa");
