...
namespace EVO_PV.Models.BusinessObjects
{
    ...
    public class BOArticleOrder : NotifyPropertyChanged
    {
        ...
        /// <summary>
        /// No es Articulo de una orden tipo borrador
        /// </summary>
        /// <value>IsNotCraftOrder</value>      
        public bool IsNotCraftOrder { get; set; }
        ...
        public decimal Quantity
        {
            ...
            set
            {
                ...
                if ((this.MaxModification != 0 && value > MaxModification) && this.IsNotCraftOrder)
                {
