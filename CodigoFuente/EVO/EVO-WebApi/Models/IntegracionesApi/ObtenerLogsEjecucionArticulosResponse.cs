...
namespace EVO_WebApi.Models.IntegracionesApi
{
    ...
    /// </summary>
    [DataContract]
    public partial class ObtenerLogsEjecucionArticulosResponse : IEquatable<ObtenerLogsEjecucionArticulosResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Lista de registros de integraciones
        /// </summary>
        /// <value>Lista de registros de integraciones</value>
        [DataMember(Name = "registros")]
        public List<ObtenerLogsEjecucionArticulosResponseRegistros> Registros { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ObtenerLogsEjecucionArticulosResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ObtenerLogsEjecucionArticulosResponse)obj);
        }

        /// <summary>
        /// Returns true if ObtenerLogsEjecucionArticulosResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ObtenerLogsEjecucionArticulosResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObtenerLogsEjecucionArticulosResponse other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(ObtenerLogsEjecucionArticulosResponse left, ObtenerLogsEjecucionArticulosResponse right)
        {
