    ...
    public class BaseController : ControllerBase
    {
        ...
        public BaseController() : base()
        {
                ...
                var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<BOPedidoConsultaResponse,PedidoConsultaResponse>();              
                cfg.CreateMap<BOArticuloConsultaResponse, ArticuloConsultaResponse>();
                cfg.CreateMap<BOAccionCompraResponse, AccionCompraResponse>();
                cfg.CreateMap<BOArticuloAccionCompraResponse,ArticuloAccionCompraResponse>();
                cfg.CreateMap<EditarPedidoRequest, BOEditarPedidoRequest>();
                cfg.CreateMap<EditarPedidoRequestArticulos, BOEditarPedidoRequestArticulos>();
                cfg.CreateMap<MotivoRespuesta,MotivoResponse>();
                cfg.CreateMap<CancelarPedidoRequest, BOCancelarPedidoRequest>();
                cfg.CreateMap<Accion, AccionResponse>();
