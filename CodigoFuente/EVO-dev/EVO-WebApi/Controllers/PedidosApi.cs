...
namespace EVO_WebApi.Controllers
{
    ...
    public class PedidosApiController : ControllerBase
    {
        ...
        //[SwaggerResponse(statusCode: 200, type: typeof(PedidoRespuestaResponse), description: "Operación realizada con éxito")]
        public virtual IActionResult CrearPedido([FromBody]PedidoRequest body)
        {
            ...
            try
            {
                ...
                BOPedidoRespuesta bOPedidoRespuesta = bLPedidos.CrearPedido(pedido);

                PedidoRespuestaResponse pedidoRespuestaResponse = this.mapper.Map<BOPedidoRespuesta,PedidoRespuestaResponse>(bOPedidoRespuesta);

                return Ok(JsonConvert.SerializeObject(pedidoRespuestaResponse));
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);                
