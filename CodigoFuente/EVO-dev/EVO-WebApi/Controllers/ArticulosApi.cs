...
namespace EVO_WebApi.Controllers
{
    ...
    public class ArticulosApiController : ControllerBase
    {
        ...
        [HttpDelete]
        [Route("/api/articulos/compra/gestionar/eliminar")]
        [ValidateModelState]
        [SwaggerOperation("EliminarCompra")]
        public virtual IActionResult EliminarCompra([FromQuery][Required()] int detallePedidoId, [FromQuery][Required()] int accionId)
        {
            logger.Info($"Entró al método EliminarCompra en ArticulosApi - EVO-WebApi con los parámetros detallePedidoId = {detallePedidoId} , accionId={accionId}");

            try
            {
                BLArticulo bLArticulo = new BLArticulo();

                return Ok(bLArticulo.EliminarCompra(detallePedidoId, accionId));
            }
        ...
        /// <response code="200">Operación realizada con éxito</response>
        [HttpDelete]
        [Route("/api/articulos/compras/gestionar/limpiar")]
        [ValidateModelState]
        [SwaggerOperation("LimpiarCompras")]
        public virtual IActionResult LimpiarCompras([FromQuery][Required()] int pedidoId)
        {
            ...
            try
            {
                ...
                return Ok(bLArticulo.LimpiarCompras(pedidoId));
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);
        ...
        /// <response code="200">Operación realizada con éxito</response>
        [HttpGet]
        [Route("/api/articulos/compra/pendientes")]
        [ValidateModelState]
        [SwaggerOperation("ObtenerArticulosCompraPendientes")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<ArticuloPendienteCompraResponse>), description: "Operación realizada con éxito")]
        public virtual IActionResult ObtenerArticulosCompraPendientes([FromQuery][Required()] int pedidoId, [FromQuery][Required()] int accionId)
        {
            logger.Info($"Entró al método ObtenerArticulosCompraPendientes en ArticulosApi - EVO-WebApi con los parámetros pedidoId =  {pedidoId} , accionId = {accionId}");

            try
            {
                BLArticulo bLArticulo = new BLArticulo();

                List<BOArticuloPendienteCompraResponse> boArticulosPendientes = bLArticulo.ObtenerArticulosCompraPendientes(pedidoId, accionId);

                List<ArticuloPendienteCompraResponse> articulosPendientes =

                this.mapper.Map<List<BOArticuloPendienteCompraResponse>, List<ArticuloPendienteCompraResponse>>(boArticulosPendientes);
        ...
        /// <response code="200">Operación realizada con éxito</response>
        [HttpPost]
        [Route("/api/articulos/compra/gestionar/finalizar")]
        [ValidateModelState]
        [SwaggerOperation("FinalizarCompra")]
        public virtual IActionResult FinalizarCompra([FromBody] ActualizarCompraRequest body)
        {
            logger.Info($"Entró al método FinalizarCompra en ArticulosApi - EVO-WebApi con los parámetros {JsonConvert.SerializeObject(body)}");

            try
            {
                BOActualizarCompraRequest bOBody = this.mapper.Map<ActualizarCompraRequest,BOActualizarCompraRequest>(body);

                BLArticulo bLArticulo = new BLArticulo();

                return Ok(bLArticulo.FinalizarCompra(bOBody));
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);
        ...
        /// <response code="200">Operación realizada con éxito</response>
        [HttpPost]
        [Route("/api/articulos/compra/gestionar/actualizar")]
        [ValidateModelState]
        [SwaggerOperation("ActualizarCompra")]
        public virtual IActionResult ActualizarCompra([FromBody] ActualizarCompraRequest body)
        {
            logger.Info($"Entró al método ActualizarCompra en ArticulosApi - EVO-WebApi con los parámetros {JsonConvert.SerializeObject(body)}");
            ...
            try
            {
                ...
                return Ok(bLArticulo.ActualizarCompra(bOBody));            
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);
        ...
        /// <response code="200">Operación realizada con éxito</response>
        [HttpPost]
        [Route("/api/articulos/compra/gestionar")]
        [ValidateModelState]
        [SwaggerOperation("AsignarCompra")]
        public virtual IActionResult AsignarCompra([FromBody] CompraRequest body)
        {
            logger.Info($"Entró al método AsignarCompra en ArticulosApi - EVO-WebApi con los parámetros {JsonConvert.SerializeObject(body)}");

            try
            {
                BOCompraRequest bOBody = this.mapper.Map<CompraRequest, BOCompraRequest>(body);

                BLArticulo bLArticulo = new BLArticulo();              

                return Ok(bLArticulo.AsignarCompra(bOBody));
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);
        ...
        /// <param name="tipoSolicitud">Tipo de Solicitud para definir si es compra o traslado</param>
        /// <response code="200">Operación realizada con éxito</response>
        [HttpGet]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(ObtenerTodosArticulosResponse), description: "Operación realizada con éxito")]
        public virtual IActionResult ObtenerTodosArticulosxBodega([FromQuery][Required()] int desde, [FromQuery][Required()] int hasta, [FromQuery][Required()] string whsCodePuntoVenta, [FromQuery][Required()] string whsCodePlanta, [FromQuery][Required()]string tipoSolicitud)
        {
            logger.Info($"Entró al método ObtenerTodosArticulosxBodega en Api Artículos con los parámetros desde={desde}, hasta={hasta} ,whsCodePuntoVenta={whsCodePuntoVenta}, whsCodePlanta={whsCodePlanta},tipoSolicitud ={tipoSolicitud} ");
            ...
            try
            {
                ...
                List<ArticuloBodega> articulosBodega = bLArticulos.ObtenerTodosArticulosxBodega(desde, hasta, whsCodePuntoVenta, whsCodePlanta,tipoSolicitud);
                ...
                int numeroTotalRegistros = bLArticulos.ObtenerConteoTodosRegistros(whsCodePuntoVenta, whsCodePlanta,tipoSolicitud);
        ...
        /// <summary>
        /// Obtiene todas las acciones del artículo
        /// </summary>
        /// <response code="200">Operación realizada con éxito</response>
        [HttpGet]
        [Route("/api/articulos/accion")]
        [ValidateModelState]
        [SwaggerOperation("ObtenerAcciones")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<AccionResponse>), description: "Operación realizada con éxito")]
        public virtual IActionResult ObtenerAcciones()
        {
            logger.Info("Entró al método ObtenerAcciones en Api Artículos sin parámetros");

            try
            {
                BLArticulo bLArticulos = new BLArticulo();

                List<Accion> accionesList = bLArticulos.ObtenerAcciones();

                List<AccionResponse> accionesResponse =

                this.mapper.Map<List<Accion>, List<AccionResponse>>(accionesList);

                return Ok(accionesResponse);
            }
            catch (EVOException e)
            {
                return StatusCode(StatusCodes.Status400BadRequest, e.Message);
