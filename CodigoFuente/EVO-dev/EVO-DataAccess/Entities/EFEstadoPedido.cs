...
namespace EVO_DataAccess.Entities
{
    ...
    {      
        ...
        [Required]
        [Description("Define si el pedido se puede modificar")]
        public bool EditarPedido { get; set; } = true;

        [Required]
        [Description("Define si el pedido se puede cancelar")]
        public bool CancelarPedido { get; set; } = true;
