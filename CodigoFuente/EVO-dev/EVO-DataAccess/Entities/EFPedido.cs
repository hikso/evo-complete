...
namespace EVO_DataAccess.Entities
{
    ...
    {        
        ...
        /// </summary>      
        public List<EFDetallePedido> DetallesXPedido { get; set; }
        ...
        [Description("Define la fecha de gestión de compra del pedido")]
        public DateTime? FechaGestionCompra { get; set; }

        [Description("Define el número del documento")]
        ...
        /// Define la propiedad de navegación a Usuario 
        /// </summary>
        [ForeignKey("UsuarioAproboId")]
        public EFUsuario UsuarioAprobo { get; set; }
    }
}