    ...
    public class BLPedido
    {
        ...
        public BOPedidoConsultaResponse ObtenerConsultaPedido(int pedidoId)
        {
            ...
            try
            {
                ...
                if (boPedido.TipoSolicitud == TiposSolicitudEnum.Compras.ToString())
                {
                    ...
                    boPedido.SolicitudA = "Área de compras";
        ...
        public SerieRespuesta ObtenerSerie(string codigoBodega)
        {
            ...
            if (respuestaSerie == null)
            {
                ...
                List<SerieRespuesta> seriesSAP = null;

                try
                {
                    seriesSAP = pedidoProxy.ObtenerSeriesSAP();
                }
                catch
                {
                    EVOException e = new EVOException(errores.errNoConexionSAP);
        ...
        /// <returns>BOPedidoRespuesta</returns>
        public BOPedidoRespuesta ActualizarPedido(Pedido pedido)
        {
            if (pedido == null)
            {
                EVOException e = new EVOException(errores.errPedidoVacio);
        ...
        //        var estadoPedidoPersistente = ObtenerEstadoPedidoxId(pedidoPersistente.EstadoPedidoId);
        //        if (estadoPedidoPersistente.Nombre == EstadosPedidoEnum.Borrador.ToString())
        //        {
        ...
        //        else
        //        {
        //            pedido.NumeroPedido = int.Parse(pedidoPersistente.NumeroPedido);
        //        }
        ...
        /// <returns>BOPedidoRespuesta</returns>
        public BOPedidoRespuesta CrearPedido(Pedido pedido)
        {
            if (pedido == null)
            {
                EVOException e = new EVOException(errores.errPedidoVacio);
            ...
            BOPedidoRespuesta bOPedidoRespuesta = new BOPedidoRespuesta() { Estado = true };
            ...
            if (pedido.TipoSolicitudId == boTipoSolicitud.TipoSolicitudId.Value && pedido.EstadoPedidoId == 2)
            {
                ...
                string respuestaSAP = string.Empty;

                try
                {
                    respuestaSAP = pedidoProxy.EnviarPedido(SerializarPedido(pedido));
                }
                catch (Exception e)
                {
                    EVOException ee = new EVOException(errores.errNoConexionSAP);
                ...
                bOPedidoRespuesta.RespuestaSAP = respuestaSAP;
                ...
                if (dAPedidos.ActualizarPedido(pedido))
                {
                    if (!string.IsNullOrEmpty(solicitudDe.Email) && estadoPedidoEnum.ToString() != EstadosPedidoEnum.Borrador.ToString())
                    {
                        try
                        {
                            ...
                            bOPedidoRespuesta.Codigo = enviarPedido.NumeroPedido;

                            return bOPedidoRespuesta;
                        }
                        catch (Exception e)
                        {
                            logger.Error(e);
                    ...
                    //bOPedidoRespuesta.Codigo = $"{pedido.WhsCode.Split("-")[1]}-{pedido.NumeroPedido}"; ;
        ...
        public bool ExistePedidoBorrador(ObtenerPedidoBorradorPeticion obtenerPedidoBorradorPeticion)
        {
            ...
            string buscarPara = obtenerPedidoBorradorPeticion.SolicitudPara;

            if (obtenerPedidoBorradorPeticion.WhsCode == obtenerPedidoBorradorPeticion.SolicitudPara)
            {
                buscarPara = "AR-COM";
            }
            ...
            try
            {
                bodega = bLBodegas.ObtenerBodegaPorCodigo(buscarPara);
            }
            catch (EVOException e)
            {
                throw e;
            ...
            if (bodega.CantidadPedidosBorradorxBodega == null)
            {
                obtenerPedidoBorradorPeticion.CantidadPedidosBorradorxBodega = 1;
            }

            obtenerPedidoBorradorPeticion.CantidadPedidosBorradorxBodega = bodega.CantidadPedidosBorradorxBodega;
            ...
            try
            {
                bodega = bLBodegas.ObtenerBodegaPorCodigo(obtenerPedidoBorradorPeticion.WhsCode);
            }
            catch (EVOException e)
            {
                throw e;
