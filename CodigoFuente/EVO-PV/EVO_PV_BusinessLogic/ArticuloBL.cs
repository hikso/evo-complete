...
namespace EVO_PV_BusinessLogic
{
    public class ArticuloBL
    {
        ...
        /// <returns></returns>
        public async Task<ObtenerArticulos> ObtenerTodosArticulosxBodega(int desde, int hasta, string whsCodePuntoVenta, string whsCodePlanta)
        {
            ObtenerArticulos obtenerArticulos = await articuloProxy.ObtenerTodosArticulosxBodega(desde, hasta, whsCodePuntoVenta, whsCodePlanta);
