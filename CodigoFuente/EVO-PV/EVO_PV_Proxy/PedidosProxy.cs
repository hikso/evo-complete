...
using EVO_PV_Proxy.WSServiceSincronizacion;
using System.IO;
...
namespace EVO_PV_Proxy
{
    ...
    public class PedidosProxy : Automapper
    {
        ...
        private void CrearSAPElement(Pedido pedido, XmlDocument doc, XmlElement SAPElement)
        {
            ...
            //Encabezado del XML 
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "DocEntry", "0"));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "CardCode", "P1-811019880"));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "ToWhsCode", pedido.SolicitudPara));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "NumAtCard", string.Empty));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "DocDate", "23/10/2019"));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "Filler", "PB-PT"));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "JrnlMemo", "Solicitud de traslado - P1-811019880"));
            SAPElement.AppendChild(CrearPropiedadEncabezado(doc, appConfig.AppSettings["Tabla"], "Comments", "HolaMundo PRUEBAapp kevin"));
            ...
            foreach (var detalle in pedido.Detalles)
            {
                ...
                SAPElement.AppendChild(CrearPropiedadDetalle(doc, appConfig.AppSettings["TablaDetalle"], "FromWhsCod", "PB-PT", LineasAfectadas, NumeroLinea));
                SAPElement.AppendChild(CrearPropiedadDetalle(doc, appConfig.AppSettings["TablaDetalle"], "WhsCode", "PV-PRA", LineasAfectadas, NumeroLinea));
                ...
                SAPElement.AppendChild(CrearPropiedadDetalle(doc, appConfig.AppSettings["TablaDetalle"], "OcrCode2", "2501", LineasAfectadas, NumeroLinea));
                SAPElement.AppendChild(CrearPropiedadDetalle(doc, appConfig.AppSettings["TablaDetalle"], "U_Pres_Producto", detalle.EstadoArticulo == 1 ? "R" : "C", LineasAfectadas, NumeroLinea));
