...
namespace EVO_WebApi.Models.RecepcionApi
{
    ...
    public partial class RecepcionEncabezadoResponse : IEquatable<RecepcionEncabezadoResponse>
    {
        ...
        /// <summary>
        /// RealizarPesaje Codigo Barras
        /// </summary>
        /// <value>Indica si se realiza el pesaje por código de barras en ese punto de venta</value>
        [DataMember(Name = "realizarPesajeCodigoBarras")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RealizarPesajeCodigoBarras: ").Append(RealizarPesajeCodigoBarras).Append("\n");            
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(RecepcionEncabezadoResponse other)
        {
            ...
            return
                ...
                (
                    RealizarPesajeCodigoBarras == other.RealizarPesajeCodigoBarras ||
                    RealizarPesajeCodigoBarras != null &&
                    RealizarPesajeCodigoBarras.Equals(other.RealizarPesajeCodigoBarras)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (RealizarPesajeCodigoBarras != null)
                    hashCode = hashCode * 59 + RealizarPesajeCodigoBarras.GetHashCode();
                return hashCode;
            }
        }
