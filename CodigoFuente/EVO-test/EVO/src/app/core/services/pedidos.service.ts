...
export class PedidosService {
   ...
   * @param from paramétro número de registro final
   * @param to parámetro número de registro inicial
   */
  getAllApproved(from, to){
    ...
    /**
     *  Obtiene los estados de artículos
     */
    getEstados(){
        return this.http.get(this.UrlHost + 'articulos/estado', { withCredentials:true } );
    }

    /**
     *  Obtiene los empaques de artículos
     */
    getEmpaques(){
        return this.http.get(this.UrlHost + 'articulos/empaques', { withCredentials:true } );
    }
  ...
  /**
   * Get the pending articles to be managed
   * @param pedidoId
   * @param accionId
   */
  getArticulosPendientesGestion(pedidoId, accionId){
    return this.http.get(this.UrlHost + 'articulos/compra/pendientes', { withCredentials:true, params:{ pedidoId: pedidoId, accionId: accionId } });
  }

    saveFile(data){
        return this.http.post(this.UrlHost + 'pedidos/cargarArchivo', data, { withCredentials: true} );
    }
  ...
  eliminarArticulo(detallePedidoId, accionId){
    return this.http.delete(this.UrlHost + 'articulos/compra/gestionar/eliminar', { withCredentials: true, params:{ detallePedidoId: detallePedidoId, accionId: accionId } } );
  }
  ...
  // Delete all actions managed
  // id: key del pedido en base de datos
  cleanPurchaceDocument(id){
    return this.http.delete(this.UrlHost + 'articulos/compras/gestionar/limpiar', { withCredentials:true, params:{ pedidoId:id } });
  }
  ...
  updateDelivery(data){
    ...
    /**
     * Post Actualizar Entrega, fechas, y articulos
     * @param data parámetros del formulario para actualizar entregas
     */
    saveEraserDelivery(data){
        return this.http.post(this.UrlHost + 'pedidos/comercial/traslado/borrador', data, { withCredentials:true });
    }
  ...
  getFilter(data){
    ...
    getFilesByFilter(data){
        return this.http.post(this.UrlHost +'cargaArchivos/filtrar', data, { withCredentials:true });
    }
