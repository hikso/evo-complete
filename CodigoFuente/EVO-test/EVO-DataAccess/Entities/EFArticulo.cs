...
namespace EVO_DataAccess.Entities
{
    ...
    public class EFArticulo
    {
        ...
        /// <summary>
        /// Define la propiedad de artiuclos que no son de compra de PV 
        /// </summary> 
        [Description("Define ArticuloCompraPV que no son de Punto de Venta")]
        [Column(TypeName = "NVARCHAR(50)")]
        public string ArticuloCompraPV { get; set; }
